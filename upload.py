...
async def upload_audio(client, message, file_loc):
    ...
    msg = await message.edit_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton(text="𝖯𝗋𝗈𝗀𝗋𝖾𝗌𝗌", callback_data="progress_msg")]])
    )
    ...
    try:
        ...
        print(e)     
        await msg.edit_text("**Some Error Occurred. Contact Admin for More Info.**")   
        return
